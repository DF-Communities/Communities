({
  ...
  function Dispatcher() 
  {
     ...
     */
    Dispatcher.prototype.register = function register(store) {
      var id = store.storeId;
      this._stores[id] = store;
      this._callbacks[id] = store.dispatchHandler;
      return id;
    };
    ...
    Dispatcher.prototype.dispatch = function dispatch(payload) {
      ...
      try {
          ...
          return this.completionPromises; //ML
      } 
      finally {
    ...
    Dispatcher.prototype._invokeCallback = function _invokeCallback(id) {
      ...
      var ret = this._callbacks[id](this._pendingPayload);
      if (ret) this.completionPromises[id] = ret; //ML
